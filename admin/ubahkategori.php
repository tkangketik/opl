...
$ambil = $koneksi->query(
    "SELECT * FROM kategori WHERE kd_kategori='$_GET[id]'"
);
...
<div class="row">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Dashboard</h1>
									...
									<form name="ubahkategori.php" method="POST" role="form" class="lead">
                                    ...
                                    <?php if (isset($_POST['submit'])) {
                                        $koneksi->query(
                                            "UPDATE kategori SET nama_kategori='$_POST[nama_kategori]' WHERE kd_kategori='$_GET[id]'"
                                        );
