...
<body style="background-image: url('/nekmit/media/tod.png');">
	...
	<div class="container">
		...
		<div class="intro-content" >
			<div class="container" >
			<h3 align="center" style="font-size:50px">Pelayanan Orion Pet Lover</h3><br /> 
<hr>
				<div class="row">
				<!-- <div class="col-md-5">	 -->
						...
						<!-- <div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s"></div> -->
							...
							<!-- <div class="panel-heading"> -->
									...
									<div class="panel-body" style="margin-right:350px; margin-left:150px;">
						...
						?>
								...
								<div class="col-md-4">  
										...
										<div class="caption text-center">
											...
											<span class="label label-danger" style="font-size:20px"><?php echo $currency; ?> <?php echo $data['harga']; ?> </span><br><br>
										...
										<input type="text" name="quantity" class="form-control" value="1" />  
											...
											<!-- <input type="text" name="quantity" class="form-control" value="1" />   -->
												...
												<input type="submit" style="margin-top:10px; margin-left:105px;" type="button" class="btn btn-primary" value="(+) Keranjang" /> </span>
			...
			<div style="clear:both"></div>  
                <br />  <br> <br>
                <strong style="font-size:30px;">Keranjang</strong>  
                <div class="table-responsive"> 
					<?php
					// If cart is empty
