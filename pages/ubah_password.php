              ...
              <form name="ubahpassword" id="ubahpassword" action="../cekubahpassword.php" method="POST" role="form" class="lead">
                <div class="login--form">
                  <div class="form-group">
                    <label for="urname">Password Lama</label>
                    <input type="password" name="passwordlama" id="passwordlama" class="text_field">
                  </div>
                  <div class="form-group">
                    <label for="urname">Password Baru</label>
                    <input type="password" name="passwordbaru" id="passwordbaru" class="text_field">
                  </div>
                  <div class="form-group">
                    <label for="urname">Konfirmasi Password</label>
                    <input type="password" name="konfirmasipassword" id="konfirmasipassword" class="text_field">
                  </div>
