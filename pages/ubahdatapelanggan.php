  ...
  <head>
    ...
    <title>Ubah Data Akun - Orion Pet Lover</title>
              ...
              <form name="ubahdatapelanggan" id="ubahdata" method="POST" role="form" class="lead">
                <div class="login--form">
                  <div class="form-group">
                    <label for="urname">Nama</label>
                    <input type="text" name="nama_pelanggan" class="text_field" value="<?php echo $pecah['nama_pelanggan']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="urname">Email</label>
                    <input type="text" class="text_field" name="email" value="<?php echo $pecah['email']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="urname">No Handphone</label>
                    <input type="text" class="text_field" name="no_hp" value="<?php echo $pecah['no_hp']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="urname">Alamat</label>
                    <input type="text" class="text_field" name="alamat" value="<?php echo $pecah['alamat']; ?>">
                  </div>
